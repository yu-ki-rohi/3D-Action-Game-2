...
void ColliderRegisterInterface::RegisterTrigger(std::shared_ptr<ObjectBase> owner_, std::shared_ptr<Collider> collider_)
{
	std::shared_ptr<CollisionManager> collision_manager = collisionManager.lock();
	if (collision_manager == nullptr) { return; }
...
void ColliderRegisterInterface::ReleaseBody(const std::shared_ptr<Collider> collider_)
{
	std::shared_ptr<CollisionManager> collision_manager = collisionManager.lock();
	if (collision_manager == nullptr) { return; }
...
void ColliderRegisterInterface::ReleaseTrigger(const std::shared_ptr<Collider> collider_)
{
	std::shared_ptr<CollisionManager> collision_manager = collisionManager.lock();
	if (collision_manager == nullptr) { return; }
